        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3 text-sm pt-2">
              <div className="flex items-center gap-2 px-4 py-2 bg-background/80 backdrop-blur rounded-lg border border-border/50">
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              ...
              <Button 
                size="default" 
                variant="outline" 
                className="h-11 px-6 text-base hover:bg-muted transition-colors" 
          ...
          <div className="relative hidden lg:block">
            <div className="relative">
              ...
              <div className="absolute bottom-6 left-6 right-6 bg-background/95 backdrop-blur-md p-5 rounded-xl border border-border/50 shadow-lg">
