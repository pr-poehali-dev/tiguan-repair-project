...
const ChatBot = () => {
  ...
  const quickAnswers = [
    ...
    },
    {
      ...
      answer: 'Стандартный срок восстановления — 5-7 рабочих дней. Срочный ремонт — от 2 рабочих дней. Точные сроки зависят от текущей загрузки производства.'
    },
    {
      question: 'Гарантия',
      answer: 'Предоставляем гарантию 18 месяцев без ограничения пробега на все восстановленные детали. Выдаём официальный гарантийный талон с печатью.'
    },
    {
      question: 'Доставка',
