...
const ServicesSection = () => {
  ...
  const services = [
...

    {
      ...
      description: 'Комплексное ТО системы 4Motion: замена масла в муфте Haldex и редукторах, диагностика электронного блока управления, проверка датчиков, замена фильтра муфты, тестирование работы полного привода.',
      features: [
