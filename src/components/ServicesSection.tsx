...
const ServicesSection = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Высокоточное восстановление изношенных шлицов на станках с ЧПУ: механическая обработка, наплавка, термообработка до HRC 58-62, контроль геометрии. Специализация на приводных валах и полуосях Tiguan.',
      features: [
