        ...
        <div className="container mx-auto">
          ...
          <div className="max-w-4xl mx-auto space-y-4">
            ...
            <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
              ...
              <CardContent>
                <p className="text-muted-foreground leading-relaxed">Да, наша запатентованная технология позволяет восстанавливать даже критически изношенные шлицы. Мы изготавливаем новые шлицы на станках с ЧПУ и проводим термообработку. Восстановленная деталь не уступает новой по прочности.</p>
              </CardContent>
            </Card>
