...
const ServicesSection = () => {
  ...
  const services = [
    ...
    {
      icon: 'Wrench',
      title: 'Калибровка деталей',
      description: 'Прецизионная калибровка карданных и приводных деталей трансмиссии для устранения вибраций и обеспечения точности'
    },
    {
      icon: 'Shield',
  ...
  const guarantees = [
    {
      ...
      items: [
        ...
        'Калибровка деталей - 12 месяцев или 30 000 км',
    ...
    },
    {
      ...
      items: [
        ...
        'Проверка геометрии деталей на калибровочном стенде',
