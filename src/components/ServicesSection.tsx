...
const ServicesSection = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Высокоточное восстановление изношенных шлицов на станках с ЧПУ: механическая обработка, термообработка до HRC 58-62, контроль геометрии. Специализация на трансмиссии Tiguan I.',
      features: [
    ...
    },
    {
      ...
      description: 'Капитальный ремонт раздаточной коробки: восстановление шлицов вала раздатки, замена подшипников, сальников. Регулировка зазоров, герметизация корпуса.',
      features: [
        'Восстановление шлицевых соединений',
...

    {
      ...
      description: 'Комплексное ТО системы 4Motion: замена масла в муфте Haldex и редукторах, диагностика электронного блока управления, проверка датчиков, замена фильтра муфты, профилактика шлицов, тестирование работы полного привода.',
      features: [
        'Замена масла Haldex (1.2 л)',
        'Замена масла в редукторах',
        'Профилактика шлицов полного привода',
        'Замена фильтра муфты'
      ],
      price: 'от 4 990 ₽',
      duration: '1 день'
    }
              ...
              <Card className="border-primary/30 bg-gradient-to-br from-primary/5 to-accent/5 backdrop-blur-sm">
                <CardContent className="p-6">
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div>
                      <h3 className="font-bold text-xl mb-1">Видео процесса</h3>
